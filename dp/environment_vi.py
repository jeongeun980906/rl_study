...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open(r"..\img\up.png").resize((13, 13)))
        right = PhotoImage(Image.open(r"..\img\right.png").resize((13, 13)))
        left = PhotoImage(Image.open(r"..\img\left.png").resize((13, 13)))
        down = PhotoImage(Image.open(r"..\img\down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open(r"..\img\rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open(r"..\img\triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open(r"..\img\/circle.png").resize((65, 65)))
